...
/** Set-once config — connect Twitch, grab overlay URLs, back up state. Reached via the gear in the header. */
const SECTIONS = [
	{ href: "/control/settings/twitch", label: "Twitch" },
	{ href: "/control/settings/overlays", label: "Overlays" },
	{ href: "/control/settings/backup", label: "Backup" },
] as const;
