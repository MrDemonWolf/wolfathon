...
function WolfMarkSvg() {
  return (
    <svg viewBox="0 0 64 64" className="h-full w-full" fill="none" aria-hidden="true">
      {/* ears */}
      <path d="M14 6 L26 20 L14 27 Z" fill="#0c1b40" stroke="#00aced" strokeWidth="2" strokeLinejoin="round" />
      <path d="M50 6 L38 20 L50 27 Z" fill="#0c1b40" stroke="#00aced" strokeWidth="2" strokeLinejoin="round" />
      {/* head */}
      <path
